...
DEFINE_PROPERTY_FIELD(GrainSegmentationModifier, handleBoundaries);
...
SET_PROPERTY_FIELD_LABEL(GrainSegmentationModifier, handleBoundaries, "Handle coherent boundaries");
